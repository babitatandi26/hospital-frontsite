...
const Faq = () => {
  ...
  const handleChange = (panel) => (event, newExpanded) => {
    ...
    return(
        <>
            <div className="faq" style={{marginTop:"100px",marginBottom:"100px"}}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-12" style={{border:"1px solid #eee"}}>
                        <div>
                            <h3 style={{margin:"20px"}}>What are Clients Say</h3>
        ...
        <AccordionDetails>
          <Typography>
            ...
            elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget.
                        ...
                        <div className="col-lg-6 col-md-6 col-12" style={{border:"1px solid #eee"}}>
                        <div>
                        <h3 style={{margin:"20px"}}>What are Doctors Say</h3>
