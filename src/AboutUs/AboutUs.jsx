...
import i1 from "../hospitalImages/007.jpg";
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-12 image1" style={{marginLeft:"-60px"}}>
                            <img src={i1} alt="i1" />
                            <p style={{color:"#fff",backgroundColor:"#118574",width:"400px",marginLeft:"71px"}}><h4>Dr. Alexender</h4>Director</p>
                        </div>
                    ...
                    <div className="row" style={{marginTop:"100px",textAlign:"left"}}>
                        <div className="col-lg-8 col-md-8 col-12">
                            <h2>Our Mission</h2>
                            <p>Mission of smart Healthcare is to <br/>provide care and services to all the patient the following facilities.</p>
                           <br/>
                            <div className="container">
                                <div className="row">
