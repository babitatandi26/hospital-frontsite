...
import img1 from "../hospitalImages/2.jpg";
          ...
          <div className="carousel-item active" data-interval="2000">
            <img src={img1} className="d-block w-100" alt="img1"/>
             <div className="carousel-caption d-none d-md-block" style={{backgroundColor:"rgba(0,0,0,0.5)"}}>
              <h2>Smart-Hospital <br/> Health and Care redefining</h2>
          </div>
          </div>
          <div className="carousel-item" data-interval="2000">
            <img src={img2} className="d-block w-100" alt="img2"/>
             <div className="carousel-caption d-none d-md-block" style={{backgroundColor:"rgba(0,0,0,0.5)"}}>
              <h2>Access World-Class specialist without leaving Home</h2>
           </div>
          </div>
          <div className="carousel-item" data-interval="2000">
            <img src={img3} className="d-block w-100" alt="img3"/>
             <div className="carousel-caption d-none d-md-block" style={{backgroundColor:"rgba(0,0,0,0.5)"}}>
              <h2>Ranked #1 in the Nation for the Patients of all ages</h2>
        </div>
          </div>
        </div>
